...
Use the project-local harness docs for product-facing portfolio work:
...
The portfolio wedge is interactive proof over static claims. Public visitor work
...
Do not add generic portfolio, SaaS, or dashboard bloat unless the current
